...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'CAN//FORM',
    description: {
      pl: 'Interaktywne doświadczenie produktowe łączące konfigurowalny model puszki w WebGL, filmowe przejścia i narrację sterowaną scrollem.',
      en: 'An interactive product experience combining a configurable WebGL can, cinematic transitions and scroll-driven storytelling.',
    },
    image: '/canform_mockup.webp',
